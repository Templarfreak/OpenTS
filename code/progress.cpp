...
/// <remarks>Nothing is drawn before Initialize, or while the progress notice is
/// shown.</remarks>
...
/// <summary>
/// Shows the progress notice in place of the full-screen progress display. Initialize()
/// calls it when the caller asks for the notice.
/// </summary>
