...
Makes the type a hunter-seeker drone that acquires its own target, moves straight at it, and is never grounded by an ion storm. The firing check never reports a shot as ready for such a type, so it does not open fire however it is armed. Its movement heads straight at its target instead of routing around what stands between them. A flying hunter seeker with no target acquires one for itself rather than landing.
