...
Every monster is measured against the figure twice before each [growth step](/systems/veins/#growth). It may queue at most the figure minus 40 frontier cells, and it may cover at most the figure minus 100 mature cells. Neither test is ever relaxed, so the figure is a hard ceiling on one monster's field rather than a target the field settles at. Every monster in the scenario shares the one setting.
