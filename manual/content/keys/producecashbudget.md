...
A payment is never skipped because the budget ran out first. A budget that is not a whole multiple of the amount pays a smaller final installment, so `1000` with an amount of `300` pays 300, 300, 300 and then 100.
